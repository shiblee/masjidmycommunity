 ...
 */
function GeometricPattern({ className = "auth-pattern" }) {
  return (
    <svg className={className} width="100%" height="100%" aria-hidden="true" focusable="false">
      <defs>
        <pattern id="mmcGirih" width="140" height="140" patternUnits="userSpaceOnUse">
        ...
        <radialGradient id="mmcFade" cx="50%" cy="35%" r="75%">
          <stop offset="0%" stopColor="#000" stopOpacity="0" />
          <stop offset="100%" stopColor="#000" stopOpacity="0.35" />
        </radialGradient>
      </defs>
      <rect width="100%" height="100%" fill="url(#mmcGirih)" />
      <rect width="100%" height="100%" fill="url(#mmcFade)" />
    </svg>
  );
}
