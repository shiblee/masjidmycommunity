...
import MyRequirements from "./pages/requirements/MyRequirements.jsx";
import RequirementForm from "./pages/requirements/RequirementForm.jsx";
    ...
    <LanguageProvider>
      ...
      <Routes>
        <Route element={<MarketingLayout />}>
          ...
          />
          <Route
            path="/account/my-requirements/new"
            element={
              <RequireUserAuth>
                <RequirementForm />
              </RequireUserAuth>
