  ...
  return (
    <>
      <button className="amx-back-link" onClick={onCancel}>
        <Icon name="arrowRight" size={14} style={{ transform: "rotate(180deg)" }} /> Back to Report Post Reasons
      </button>
      <h3 style={{ marginBottom: 20 }}>{isEdit ? "Edit Report Reason" : "Add Report Reason"}</h3>
