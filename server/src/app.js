...
import adminDeveloperRoutes from "./routes/adminDeveloperRoutes.js";
...
import masjidPhotoProxyRoutes from "./routes/masjidPhotoProxyRoutes.js";
...
import adminReelDeletionReasonRoutes from "./routes/adminReelDeletionReasonRoutes.js";
...
import adminExperienceLevelRoutes from "./routes/adminExperienceLevelRoutes.js";
import adminJobCategoryRoutes from "./routes/adminJobCategoryRoutes.js";
...
import adminMasjidBotRoutes from "./routes/adminMasjidBotRoutes.js";
...
app.use("/api/masjids/photos", masjidPhotoProxyRoutes);
...
app.use("/api/admin/masjid-bot", adminMasjidBotRoutes);
...
app.use("/api/admin/reel-deletion-reasons", adminReelDeletionReasonRoutes);
...
app.use("/api/admin/experience-levels", adminExperienceLevelRoutes);
