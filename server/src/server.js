...
import { ensureVerificationDocumentTypeDefaults } from "./seed/verificationDocumentTypeDefaults.js";
...
connectDB()
  .then(() =>
    Promise.all([
      ...
      ensureVerificationDocumentTypeDefaults(),
